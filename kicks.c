...
void do_the_kick(int i, integertime tstart, integertime tend, integertime tcurrent, int mode)
{
  ...
  double delta_t;                                                                                                                                                                                double dmdt; //para el caso simple esto es constante. dmdt = mf -m0 / tf -t0                                                                                                                  
  //dmdt= P[i].Mass - P[i].finalMass / tf - TimeBegin  (??)                                         
  dmdt=0.01;   
  double oldmass, mass_t;                                                                                                                                                                        oldmass = mass_t = P[i].Mass;                                                                                                                                                                 
  ...
  if(P[i].Type == 1)                                                                                                                                                                         
    ...
    {                                                                                                                                                                                        
      ...
      //    {                                                                                                                                                                  
		  ...
		  delta_t=(tend - tstart) * All.Timebase_interval / All.cf_hubble_a; //bintimestep for the active bin                                                                                                         
		  increment = dmdt * delta_t;                                                                                                                                              
		  //mass                                                                                                                                                                     
		  oldmass = P[i].realmass;                                                                                                                                                   
		  mass_t = oldmass + increment;                                                                                                                                              
		  P[i].realmass = mass_t;                                                                                                                                                   
