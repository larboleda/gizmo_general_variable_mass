...
#if ((defined(RT_FLUXLIMITER) || defined(FLAG_NOT_IN_PUBLIC_CODE_EDDINGTON) || defined(FLAG_NOT_IN_PUBLIC_CODE)) && !defined(RT_EVOLVE_FLUX)) && !defined(RT_EVOLVE_EDDINGTON_TENSOR)
...
#if defined(RT_COOLING) && !defined(FLAG_NOT_IN_PUBLIC_CODE)
#define COOLING
#endif
...
#define AGS_OUTPUTGRAVSOFT 0  /*! output softening to snapshots */
#define AGS_OUTPUTZETA 0 /*! output correction zeta term to snapshots */
#endif
...
extern ALIGN(32) struct particle_data
{
  ...
  MyDouble realmass; //MassTrue             /*!< true particle mass ('mass' now is -predicted- mass */
  //MyDouble increment;          //dMass       /*!< change in particle masses from hydro step (conserved variable) */
  //MyDouble dmdt; //DtMass               /*!< rate-of-change of particle masses (for drifting) */
  //===============================================================================================================
